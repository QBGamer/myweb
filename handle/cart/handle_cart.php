<?php
    ...
    echo '<div class="row border-bottom mb-2">
            <div class="col fs-5">Sản phẩm</div>
    ...
    foreach($result as $item){
        ...
        echo '<div class="row mt-4">
                ...
                <div class="col align-self-center">'.number_format($item['prd_price']).' đ</div>
                ...
                <div class="col align-self-center"><button type="button" class="btn btn-danger border" data-type=3 data-id='.$item['cart_id'].' onclick="controlCart(this)">Xóa</button></div>
            </div>';
    }
